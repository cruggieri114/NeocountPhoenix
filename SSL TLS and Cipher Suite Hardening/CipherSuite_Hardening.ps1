...
function enable-tls-1-3 {
    ...
    New-ItemProperty -Path ‘HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.3\Server’ -Name ‘Enabled’ -Value ‘0xffffffff’ –PropertyType DWORD
